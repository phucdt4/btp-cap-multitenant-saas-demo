...
annotate sap.common.Countries with @cds.autoexpose: true;
annotate sap.common.Languages with @cds.autoexpose: true;
annotate sap.common.Currencies with @cds.autoexpose: true;
